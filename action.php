...
<html>
  <head>
    <meta charset="UTF-8">
    <title>Action - <?php require('get_title.php'); ?></title>
  ...
  <body class="skin-blue">
    <div class="wrapper">
      ...
      <header class="main-header">
        <!-- Logo -->
        <a href="index.php" class="logo"><b>Rental </b>DVD</a>
      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview <?php if(isset($_GET['page']) && $_GET['page']=="data_customers") { echo "active"; } ?>">
              <a href="./?page=data_customers">
                <i class="fa fa-user"></i> <span>Data Customers</span> 
              </a>
            </li>
      ...
      <footer class="main-footer">
        ...
        <strong>Copyright &copy; <?php echo date('Y'); ?> <a href="#">Rental DVD</a></strong>
      </footer>
    </div><!-- ./wrapper -->
