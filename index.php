...
<html>
  <head>
    <meta charset="UTF-8">
    <title>Rental DVD - <?php require('get_title.php'); ?></title>
      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <!-- PAGE DATA CUSTOMER -->
            <li class="treeview <?php if(isset($_GET['page']) && $_GET['page']=="data_customer" | $_GET['action']=="data_customer") { echo "active"; } ?>">
